...
const DietPlans = () => {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
      <div className="mb-16">
        <h2 className="text-orange-600 font-bold uppercase tracking-widest text-sm mb-2">Fuel Systems</h2>
        <h1 className="text-5xl font-black uppercase italic tracking-tighter">Nutrition Plans</h1>
      </div>
